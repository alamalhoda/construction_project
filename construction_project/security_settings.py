...
DEVELOPMENT_SECURITY_SETTINGS = {
    ...
    'CSP_SCRIPT_SRC': ("'self'", "'unsafe-inline'", "'unsafe-eval'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://lib.arvancloud.ir", "https://unpkg.com", "https://code.jquery.com", "https://stackpath.bootstrapcdn.com","https://lib.arvancloud.ir"),
    'CSP_STYLE_SRC': ("'self'", "'unsafe-inline'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com","https://lib.arvancloud.ir", "https://fonts.googleapis.com", "https://stackpath.bootstrapcdn.com", "https://unpkg.com", "https:"),
    'CSP_FONT_SRC': ("'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "https://lib.arvancloud.ir", "https://stackpath.bootstrapcdn.com", "https:", "data:"),
...
PRODUCTION_SECURITY_SETTINGS = {
    ...
    'CSP_DEFAULT_SRC': ("'self'", "'unsafe-inline'", "'unsafe-eval'", "data:", "blob:", "https:", "http:"),
    'CSP_SCRIPT_SRC': ("'self'", "'unsafe-inline'", "'unsafe-eval'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://lib.arvancloud.ir", "", "https://unpkg.com", "https://code.jquery.com", "https://stackpath.bootstrapcdn.com","https://lib.arvancloud.ir"),
    'CSP_STYLE_SRC': ("'self'", "'unsafe-inline'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://lib.arvancloud.ir", "https://fonts.googleapis.com", "https://stackpath.bootstrapcdn.com", "https://unpkg.com", "https:","https://lib.arvancloud.ir"),
    'CSP_FONT_SRC': ("'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "https://lib.arvancloud.ir", "https://stackpath.bootstrapcdn.com", "https:", "data:"),
    'CSP_IMG_SRC': ("'self'", "data:", "https:", "http:", "blob:"),
    'CSP_CONNECT_SRC': ("'self'", "https:", "http:"),
    'CSP_FRAME_SRC': ("'self'", "https:", "http:"),
