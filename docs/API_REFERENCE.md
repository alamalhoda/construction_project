...
#### 5. Export فایل Excel (جدید - فاز اول)
- **Endpoint**: `GET /api/v1/Project/export_excel/`
- **توضیح**: دریافت فایل Excel کامل با تمام اطلاعات و محاسبات پروژه
- **نوع**: Static (محاسبات در سرور انجام می‌شود)
- **فرمت خروجی**: فایل Excel (.xlsx)
- **نام فایل**: `project_{نام_پروژه}_{تاریخ_و_زمان}.xlsx`

**شیت‌های موجود در فایل (15 شیت):**
...
**برنامه آینده:**
- **فاز دوم**: افزودن پارامتر `?type=dynamic` برای فایل با فرمول‌های اکسل
