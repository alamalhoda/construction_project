...
1. **دقت محاسبات**: تمام محاسبات باید با دقت بالا انجام شوند
2. **اعتبارسنجی**: ورودی‌ها باید اعتبارسنجی شوند
3. **مدیریت خطا**: خطاهای محاسباتی باید مدیریت شوند
4. **مستندسازی**: تمام فرمول‌ها باید مستند شوند
5. **تست**: تمام محاسبات باید تست شوند
