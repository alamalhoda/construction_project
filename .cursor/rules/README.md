...
### 4. **`api-documentation-standards.md`**
قانون استانداردهای مستندات API
- Single Source of Truth: Serializer با help_text
- قوانین docstrings برای API methods
- بهینه‌سازی برای LLM و RAG system
- چک‌لیست برای ViewSet های جدید
